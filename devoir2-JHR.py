...
### BONJOUR AMÉLIE! EXCELLENT SCRIPT! IL Y A SURTOUT UNE CHOSE À SURVEILLER. VOIR NOTES PLUS BAS :)
...
for lobbies in lobby["registre"]: 
    infos=[]
    comlog=lobbies[0]["comlog_id"] ### ATTENTION, ICI JE NE VOUS DEMANDAIS PAS CET ID, MAIS LE NUMÉRO DE CODE DE L'ENTREPRISE
    nomfr=lobbies[0]["fr_client_org_corp_nm"]
    nomen=lobbies[0]["en_client_org_corp_nm"]
    date=lobbies[0]["date_comm"]
    objet=lobbies[1][0]["objet"] ### ATTENTION, ICI TON SCRIPT NE RÉCUPÈRE LES TENTATIVES DE LOBBYING CLIMATIQUE UNIQUEMENT LORSQUE LE PREMIER SUJET EST "CLIMAT"
    objetautre=lobbies[1][0]["objet_autre"] ### PARFOIS, LE CLIMAT EST LE 2E OU 3E SUJET... TON SCRIPT NE LES VÉRIFIE PAS. TU AS AINSI 745 RÉSULTATS AU LIEU DES 2564 ATTENDUS.
